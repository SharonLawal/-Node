...
import { Settings, HardDrive, Cpu, ShoppingBag } from 'lucide-react';
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              onChange={(e) => setConfig({ ...config, software: e.target.value as NodeConfig['software'] })}
              className="flex-1 rounded border-gray-300 focus:border-green-500 focus:ring-green-500"
            >
              {['Dappnode', 'Stereum', 'Sege', 'Coincashew', 'Blockops'].map(software => (
          ...
          <div className="flex items-center space-x-2">
            ...
            <select
              value={config.ram}
              onChange={(e) => setConfig({ ...config, ram: e.target.value as NodeConfig['ram'] })}
              className="flex-1 rounded border-gray-300 focus:border-green-500 focus:ring-green-500"
            >
          ...
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              onChange={(e) => setConfig({ ...config, storage: e.target.value as NodeConfig['storage'] })}
              className="flex-1 rounded border-gray-300 focus:border-green-500 focus:ring-green-500"
            >
          ...
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              onChange={(e) => setConfig({ ...config, processor: e.target.value as NodeConfig['processor'] })}
              className="flex-1 rounded border-gray-300 focus:border-green-500 focus:ring-green-500"
            >
